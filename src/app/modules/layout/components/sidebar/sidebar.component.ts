...
import { LayoutMatchMediaService } from '../../services/match-media.service';
...
export class SidebarComponent implements OnInit, OnDestroy
{
   ...
   * @param {LayoutMatchMediaService} _layoutMatchMediaService
  ...
  constructor(
      ...
      private _layoutMatchMediaService: LayoutMatchMediaService,
  ...
  private _setupLockedOpen(): void
  {
      ...
      this._layoutMatchMediaService.onMediaChange
          .pipe(takeUntil(this._unsubscribeAll))
          .subscribe(() => {
